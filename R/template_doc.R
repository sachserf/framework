           ...
           doctype = "html")
  {
    ...
    # write file
      ...
      cat(
        ...
        "'\n#' date: '",
        Date, 
        "'\n#' output: \n#'  html_document:\n#'    theme: journal\n#'    highlight: tango\n#'    df_print: kable\n#'    fig_caption: yes\n#'    number_sections: yes\n#'    collapsed: yes\n#'    code_folding: hide\n#'    toc: yes\n#'    toc_float: yes\n#'    toc_depth: 5\n#' #    keep_md: yes\n#'---\n\n#+ setup_", header, ", include=FALSE\n# set knitr chunk options\n   # pdf AND png output of figures: first 'dev'-value should be suitable for output format specified in YAML metadata (html+word = raster graphics, pdf = vector graphics) --> for raster graphics: optionally adjust dpi\nknitr::opts_chunk$set(dev = c('png', 'pdf'), \n                      dpi = 100)\n#' # Note\n#' This file was created by calling the function 'framework::template_doc'.\n#+ chunk_label\n\n",
        file = file,
        sep = ""
      )
    }
